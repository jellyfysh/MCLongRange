...
#
# This program implements the standard Metropolis algorithm for a two dimensional Lennard-Jones system.
# It is discussed in Section II.A of the manuscript, but it is not explicitly illustrated in a pseudocode algorithm.
#
...
# with open('ScalingData/MetropolisScaling_rho' + str(density) + '.data', "a") as file:
...
# with open('PairCorrelationData/Metropolis_N' + str(N) + '_rho' + str(density) + '_Correlation.data', "w") as file:
